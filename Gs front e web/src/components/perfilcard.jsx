    ...
    <div
     ...
     >
      <div className="flex space-x-4  ">
        ...
        />
        <div>
          <h3 className="text-xl font-bold text-gray-900 dark:text-gray-50">{perfil.nome}</h3>
          <p className='text-xl text-gray-900 font-medium dark:text-gray-50'>{perfil.idade}</p>
          <p className="text-normal text-blue-700 font-medium  dark:text-indigo-400">{perfil.cargo}</p>
        </div>
      </div>
      <div className="mt-4">
        <p className="text-gray-900 text-md mb-3 line-clamp-2 0 dark:text-gray-50">{perfil.resumo}</p>
