        ...
        <div className="p-6 md:p-8">
          ...
          <div className="flex justify-end space-x-4 mt-8 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button
              ...
              className="px-6 py-2 border border-indigo-600 text-indigo-600 font-semibold rounded-lg hover:bg-indigo-50 dark:hover:bg-gray-700  dark:bg-[#f2f2f2]/40 transition duration-150"
            >
              Enviar Mensagem
            </button>
          </div>
