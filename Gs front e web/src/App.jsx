  ...
  return (
    <> 
      <main className="container bg-gray-100  mx-auto p-4 pt-8">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-8 bg-white 0 p-4 rounded-lg shadow-md">
          {/* BUSCA */}
          <input
            type="text"
            ...
            className="flex-grow p-3 border border-gray-400  rounded-lg bg-blue-100 text-black-800  "
          />
          ...
          <select
            ...
            className="p-3 border border-gray-700 rounded-lg bg-blue-900 text-white appearance-none  "
          >
